...
- Accept and process customer orders.<br> (**STATUS:** 🟩)
  A. If the ordered product is currently out of stock, customer can pre-order that product. <br>(**STATUS:** 🟥)
  B. If the order was a "cake", customer can include custom writing on the cake and it also includes a candle for free.  <br> (**STATUS:** 🟥)
  C. Giving customer an option if they want it delivered straight to them or by pickup. <br>(**STATUS:** 🟥)
